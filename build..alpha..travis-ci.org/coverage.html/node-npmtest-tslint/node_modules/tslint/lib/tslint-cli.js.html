...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-tslint/node_modules/tslint/lib/tslint-cli.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-tslint/node_modules/tslint/lib/tslint-cli.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-tslint/node_modules/tslint/lib/</a> &#187; tslint-cli.js</div>
</div>
<div class="body">
...
var processed = optimist
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!(argv.h || argv.i || argv.test || argv.v || argv.project || argv._.length &gt; 0)) {
        // throw a string, otherwise a call stack is printed for this message
        // tslint:disable-next-line:no-string-throw
        throw "Missing files";
    }
<span class="cstat-no" title="statement not covered" >    if (argv.f) {</span>
        // throw a string, otherwise a call stack is printed for this message
        // tslint:disable-next-line:no-string-throw
<span class="cstat-no" title="statement not covered" >        throw "-f option is no longer available. Supply files directly to the tslint command instead.";</span>
    }
})
    .options({
    "c": {
...
var outputStream;
<span class="missing-if-branch" title="if path not taken" >I</span>if (argv.o != null) {
<span class="cstat-no" title="statement not covered" >    outputStream = fs.createWriteStream(argv.o, {</span>
        flags: "w+",
        mode: 420,
    });
}
